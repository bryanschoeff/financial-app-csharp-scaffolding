...
{
  public class StatementOfNetPosition_ProprietaryFunds_EnterpriseFundsLandfill
  {
    ...
    public StatementOfNetPosition_ProprietaryFunds_EnterpriseFundsLandfill()
    {
      this.Id = -1;
    }
    ...
    public void Load(int Id)
    {
      ...
      {
        SqlCommand command = new SqlCommand("County_GAAP_StatementOfNetPosition_ProprietaryFunds_EnterpriseFundsLandfillGetByID", connection);
        SqlDataReader reader;
        
        command.Parameters.AddWithValue("@StatementOfNetPosition_ProprietaryFunds_EnterpriseFundsLandfillId", Id);
    ...
    protected void SaveNew()
    {
      using (SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["connection"].ConnectionString + ";initial catalog=OnlineFinancialStatements"))
      {
        SqlCommand command = new SqlCommand("County_GAAP_StatementOfNetPosition_ProprietaryFunds_EnterpriseFundsLandfillAdd", connection);
    ...
    protected void Update()
    {
      using (SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["connection"].ConnectionString + ";initial catalog=OnlineFinancialStatements"))
      {
        SqlCommand command = new SqlCommand("County_GAAP_StatementOfNetPosition_ProprietaryFunds_EnterpriseFundsLandfillUpdate", connection);

        command.Parameters.AddWithValue("@StatementOfNetPosition_ProprietaryFunds_EnterpriseFundsLandfillId", this.Id);
    ...
    public void Delete()
    {
      using (SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["connection"].ConnectionString + ";initial catalog=OnlineFinancialStatements"))
      {
        SqlCommand command = new SqlCommand("County_GAAP_StatementOfNetPosition_ProprietaryFunds_EnterpriseFundsLandfillDelete", connection);
