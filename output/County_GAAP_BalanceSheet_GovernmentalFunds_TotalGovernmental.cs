...
{
  public class BalanceSheet_GovernmentalFunds_TotalGovernmental
  {
    ...
    public BalanceSheet_GovernmentalFunds_TotalGovernmental()
    {
      this.Id = -1;
    }
    ...
    public void Load(int Id)
    {
      ...
      {
        SqlCommand command = new SqlCommand("County_GAAP_BalanceSheet_GovernmentalFunds_TotalGovernmentalGetByID", connection);
        SqlDataReader reader;
        
        command.Parameters.AddWithValue("@BalanceSheet_GovernmentalFunds_TotalGovernmentalId", Id);
    ...
    protected void SaveNew()
    {
      using (SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["connection"].ConnectionString + ";initial catalog=OnlineFinancialStatements"))
      {
        SqlCommand command = new SqlCommand("County_GAAP_BalanceSheet_GovernmentalFunds_TotalGovernmentalAdd", connection);
    ...
    protected void Update()
    {
      using (SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["connection"].ConnectionString + ";initial catalog=OnlineFinancialStatements"))
      {
        SqlCommand command = new SqlCommand("County_GAAP_BalanceSheet_GovernmentalFunds_TotalGovernmentalUpdate", connection);

        command.Parameters.AddWithValue("@BalanceSheet_GovernmentalFunds_TotalGovernmentalId", this.Id);
    ...
    public void Delete()
    {
      using (SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["connection"].ConnectionString + ";initial catalog=OnlineFinancialStatements"))
      {
        SqlCommand command = new SqlCommand("County_GAAP_BalanceSheet_GovernmentalFunds_TotalGovernmentalDelete", connection);
